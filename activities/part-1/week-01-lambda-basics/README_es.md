...
// for my case: sam local invoke StartSimulationFunction --profile um_aws --env-vars env.json for as the default aws profile overlaps with my work aws profile.
```
