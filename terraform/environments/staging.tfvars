...
# (~$0.83/day: 2 Fargate tasks + 2 public IPs). Images must already be in ECR
# (pushed by a prior staging deploy). Requires enable_ecs = true.
# NOTE: flip back to false when the demo window ends to stop billing.
